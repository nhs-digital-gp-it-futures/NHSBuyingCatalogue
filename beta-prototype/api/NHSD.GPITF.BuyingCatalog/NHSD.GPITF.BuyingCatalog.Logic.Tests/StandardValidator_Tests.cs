...
{
  [TestFixture]
  public sealed class StandardValidator_Tests
  {
    ...
    {
      Assert.DoesNotThrow(() => new StandardValidator(_context.Object));
    }
    ...
    public void Validate_Admin_Create_Returns_NoError()
    {
      ...
      var validator = new StandardValidator(_context.Object);

      var valres = validator.Validate(new Standard(), ruleSet: nameof(IStandardLogic.Create));
    ...
    public void Validate_Admin_Update_Returns_NoError()
    {
      ...
      var valres = validator.Validate(new Standard(), ruleSet: nameof(IStandardLogic.Update));
