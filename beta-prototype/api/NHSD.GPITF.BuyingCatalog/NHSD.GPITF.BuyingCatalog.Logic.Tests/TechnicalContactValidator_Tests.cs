...
{
  [TestFixture]
  public sealed class TechnicalContactValidator_Tests
  {
    ...
    {
      Assert.DoesNotThrow(() => new TechnicalContactValidator(_context.Object, _solutionDatastore.Object));
    }
    ...
    {
      yield return nameof(ITechnicalContactLogic.Create);
      yield return nameof(ITechnicalContactLogic.Update);
      yield return nameof(ITechnicalContactLogic.Delete);
    }
  }
}
