...
{
  [TestFixture]
  public sealed class CapabilityValidator_Tests
  {
    ...
    {
      Assert.DoesNotThrow(() => new CapabilityValidator(_context.Object));
    }
    ...
    public void Validate_Admin_Create_Returns_NoError()
    {
      ...
      var valres = validator.Validate(new Capability(), ruleSet: nameof(ICapabilityLogic.Create));
