...
namespace NHSD.GPITF.BuyingCatalog.Controllers
{
  ...
  public sealed class AssessmentMessageController : Controller
  {
    private readonly IAssessmentMessageLogic _logic;

    /// <summary>
    /// constructor
    /// </summary>
    /// <param name="logic">business logic</param>
    public AssessmentMessageController(IAssessmentMessageLogic logic)
    {
      _logic = logic;
    }
    ...
    [ValidateModelState]
    [SwaggerResponse(statusCode: (int)HttpStatusCode.OK, type: typeof(PaginatedList<AssessmentMessage>), description: "Success")]
    ...
    public IActionResult BySolution([FromRoute][Required]string solutionId, [FromQuery]int? pageIndex, [FromQuery]int? pageSize)
    {
      ...
      var retval = PaginatedList<AssessmentMessage>.Create(assMesses, pageIndex, pageSize);
    ...
    [Route("Create")]
    [ValidateModelState]
    [SwaggerResponse(statusCode: (int)HttpStatusCode.OK, type: typeof(AssessmentMessage), description: "Success")]
    [SwaggerResponse(statusCode: (int)HttpStatusCode.NotFound, description: "Solution not found in CRM")]
    [SwaggerRequestExample(typeof(AssessmentMessage), typeof(AssessmentMessageExample), jsonConverter: typeof(StringEnumConverter))]
    ...
    [SwaggerRequestExample(typeof(AssessmentMessage), typeof(AssessmentMessageExample), jsonConverter: typeof(StringEnumConverter))]
    public IActionResult Update([FromBody]AssessmentMessage assMess)
    {
      try
      {
