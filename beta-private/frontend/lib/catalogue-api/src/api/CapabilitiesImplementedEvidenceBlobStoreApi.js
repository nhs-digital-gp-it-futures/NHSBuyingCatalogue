...
(function(root, factory) {
  ...
  /**
   * CapabilitiesImplementedEvidenceBlobStore service.
   * @module api/CapabilitiesImplementedEvidenceBlobStoreApi
   * @version 1.0.0-private-beta
   */

  /**
   * Constructs a new CapabilitiesImplementedEvidenceBlobStoreApi. 
   * @alias module:api/CapabilitiesImplementedEvidenceBlobStoreApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     */
    this.apiCapabilitiesImplementedEvidenceBlobStoreAddEvidenceForClaimPostWithHttpInfo = function(claimId, file, filename, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'claimId' is set
      if (claimId === undefined || claimId === null) {
        throw new Error("Missing the required parameter 'claimId' when calling apiCapabilitiesImplementedEvidenceBlobStoreAddEvidenceForClaimPost");
      }

      // verify the required parameter 'file' is set
      if (file === undefined || file === null) {
        throw new Error("Missing the required parameter 'file' when calling apiCapabilitiesImplementedEvidenceBlobStoreAddEvidenceForClaimPost");
      }

      // verify the required parameter 'filename' is set
      if (filename === undefined || filename === null) {
        throw new Error("Missing the required parameter 'filename' when calling apiCapabilitiesImplementedEvidenceBlobStoreAddEvidenceForClaimPost");
      }
      ...
      return this.apiClient.callApi(
        '/api/CapabilitiesImplementedEvidenceBlobStore/AddEvidenceForClaim', 'POST',
    ...
    this.apiCapabilitiesImplementedEvidenceBlobStoreEnumerateClaimFolderTreeBySolutionIdGetWithHttpInfo = function(solutionId, opts) {
      ...
      if (solutionId === undefined || solutionId === null) {
        throw new Error("Missing the required parameter 'solutionId' when calling apiCapabilitiesImplementedEvidenceBlobStoreEnumerateClaimFolderTreeBySolutionIdGet");
      }
     ...
     */
    this.apiCapabilitiesImplementedEvidenceBlobStoreEnumerateFolderByClaimIdGetWithHttpInfo = function(claimId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'claimId' is set
      if (claimId === undefined || claimId === null) {
        throw new Error("Missing the required parameter 'claimId' when calling apiCapabilitiesImplementedEvidenceBlobStoreEnumerateFolderByClaimIdGet");
      }
      ...
      return this.apiClient.callApi(
        '/api/CapabilitiesImplementedEvidenceBlobStore/EnumerateFolder/{claimId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     */
    this.apiCapabilitiesImplementedEvidenceBlobStoreEnumerateFolderByClaimIdGet = function(claimId, opts) {
      return this.apiCapabilitiesImplementedEvidenceBlobStoreEnumerateFolderByClaimIdGetWithHttpInfo(claimId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
