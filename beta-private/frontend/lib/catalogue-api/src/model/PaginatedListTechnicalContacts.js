...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TechnicalContacts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TechnicalContacts'));
  } else {
    // Browser globals (root is window)
    if (!root.CatalogueApi) {
      root.CatalogueApi = {};
    }
    root.CatalogueApi.PaginatedListTechnicalContacts = factory(root.CatalogueApi.ApiClient, root.CatalogueApi.TechnicalContacts);
  }
}(this, function(ApiClient, TechnicalContacts) {
  'use strict';
  ...
  /**
   * The PaginatedListTechnicalContacts model module.
   * @module model/PaginatedListTechnicalContacts
   * @version 1.0.0-private-beta
   */

  /**
   * Constructs a new <code>PaginatedListTechnicalContacts</code>.
   * A paged list of objects
   * @alias module:model/PaginatedListTechnicalContacts
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedListTechnicalContacts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedListTechnicalContacts} obj Optional instance to populate.
   * @return {module:model/PaginatedListTechnicalContacts} The populated <code>PaginatedListTechnicalContacts</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [TechnicalContacts]);
      }
  ...
  /**
   * List of items
   * @member {Array.<module:model/TechnicalContacts>} items
   */
