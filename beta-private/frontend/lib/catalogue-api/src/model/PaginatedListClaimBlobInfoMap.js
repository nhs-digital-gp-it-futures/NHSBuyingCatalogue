...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ClaimBlobInfoMap'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ClaimBlobInfoMap'));
  } else {
    // Browser globals (root is window)
    if (!root.CatalogueApi) {
      root.CatalogueApi = {};
    }
    root.CatalogueApi.PaginatedListClaimBlobInfoMap = factory(root.CatalogueApi.ApiClient, root.CatalogueApi.ClaimBlobInfoMap);
  }
}(this, function(ApiClient, ClaimBlobInfoMap) {
  'use strict';
  ...
  /**
   * The PaginatedListClaimBlobInfoMap model module.
   * @module model/PaginatedListClaimBlobInfoMap
   * @version 1.0.0-private-beta
   */

  /**
   * Constructs a new <code>PaginatedListClaimBlobInfoMap</code>.
   * A paged list of objects
   * @alias module:model/PaginatedListClaimBlobInfoMap
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedListClaimBlobInfoMap</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedListClaimBlobInfoMap} obj Optional instance to populate.
   * @return {module:model/PaginatedListClaimBlobInfoMap} The populated <code>PaginatedListClaimBlobInfoMap</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [ClaimBlobInfoMap]);
      }
  ...
  /**
   * List of items
   * @member {Array.<module:model/ClaimBlobInfoMap>} items
   */
