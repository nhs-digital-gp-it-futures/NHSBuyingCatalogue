...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Solutions'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Solutions'));
  } else {
    // Browser globals (root is window)
    if (!root.CatalogueApi) {
      root.CatalogueApi = {};
    }
    root.CatalogueApi.PaginatedListSolutions = factory(root.CatalogueApi.ApiClient, root.CatalogueApi.Solutions);
  }
}(this, function(ApiClient, Solutions) {
  'use strict';
  ...
  /**
   * The PaginatedListSolutions model module.
   * @module model/PaginatedListSolutions
   * @version 1.0.0-private-beta
   */

  /**
   * Constructs a new <code>PaginatedListSolutions</code>.
   * A paged list of objects
   * @alias module:model/PaginatedListSolutions
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedListSolutions</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedListSolutions} obj Optional instance to populate.
   * @return {module:model/PaginatedListSolutions} The populated <code>PaginatedListSolutions</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [Solutions]);
      }
  ...
  /**
   * List of items
   * @member {Array.<module:model/Solutions>} items
   */
