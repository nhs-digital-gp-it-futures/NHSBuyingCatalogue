...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Contacts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Contacts'));
  } else {
    // Browser globals (root is window)
    if (!root.CatalogueApi) {
      root.CatalogueApi = {};
    }
    root.CatalogueApi.PaginatedListContacts = factory(root.CatalogueApi.ApiClient, root.CatalogueApi.Contacts);
  }
}(this, function(ApiClient, Contacts) {
  'use strict';
  ...
  /**
   * The PaginatedListContacts model module.
   * @module model/PaginatedListContacts
   * @version 1.0.0-private-beta
   */

  /**
   * Constructs a new <code>PaginatedListContacts</code>.
   * A paged list of objects
   * @alias module:model/PaginatedListContacts
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedListContacts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedListContacts} obj Optional instance to populate.
   * @return {module:model/PaginatedListContacts} The populated <code>PaginatedListContacts</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [Contacts]);
      }
  ...
  /**
   * List of items
   * @member {Array.<module:model/Contacts>} items
   */
