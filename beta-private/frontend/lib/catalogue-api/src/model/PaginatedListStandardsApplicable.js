...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StandardsApplicable'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StandardsApplicable'));
  } else {
    // Browser globals (root is window)
    if (!root.CatalogueApi) {
      root.CatalogueApi = {};
    }
    root.CatalogueApi.PaginatedListStandardsApplicable = factory(root.CatalogueApi.ApiClient, root.CatalogueApi.StandardsApplicable);
  }
}(this, function(ApiClient, StandardsApplicable) {
  'use strict';
  ...
  /**
   * The PaginatedListStandardsApplicable model module.
   * @module model/PaginatedListStandardsApplicable
   * @version 1.0.0-private-beta
   */

  /**
   * Constructs a new <code>PaginatedListStandardsApplicable</code>.
   * A paged list of objects
   * @alias module:model/PaginatedListStandardsApplicable
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedListStandardsApplicable</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedListStandardsApplicable} obj Optional instance to populate.
   * @return {module:model/PaginatedListStandardsApplicable} The populated <code>PaginatedListStandardsApplicable</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [StandardsApplicable]);
      }
  ...
  /**
   * List of items
   * @member {Array.<module:model/StandardsApplicable>} items
   */
