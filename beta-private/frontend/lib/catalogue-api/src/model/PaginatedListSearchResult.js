...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CatalogueApi.PaginatedListSearchResult = factory(root.CatalogueApi.ApiClient, root.CatalogueApi.SearchResult);
  }
  ...
  /**
   * The PaginatedListSearchResult model module.
   * @module model/PaginatedListSearchResult
   * @version 1.0.0-private-beta
   */

  /**
   * Constructs a new <code>PaginatedListSearchResult</code>.
   * A paged list of objects
   * @alias module:model/PaginatedListSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedListSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedListSearchResult} obj Optional instance to populate.
   * @return {module:model/PaginatedListSearchResult} The populated <code>PaginatedListSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [SearchResult]);
      }
  ...
  /**
   * List of items
   * @member {Array.<module:model/SearchResult>} items
   */
