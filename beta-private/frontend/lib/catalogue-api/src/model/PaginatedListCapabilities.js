...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Capabilities'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Capabilities'));
  } else {
    // Browser globals (root is window)
    if (!root.CatalogueApi) {
      root.CatalogueApi = {};
    }
    root.CatalogueApi.PaginatedListCapabilities = factory(root.CatalogueApi.ApiClient, root.CatalogueApi.Capabilities);
  }
}(this, function(ApiClient, Capabilities) {
  'use strict';
  ...
  /**
   * The PaginatedListCapabilities model module.
   * @module model/PaginatedListCapabilities
   * @version 1.0.0-private-beta
   */

  /**
   * Constructs a new <code>PaginatedListCapabilities</code>.
   * A paged list of objects
   * @alias module:model/PaginatedListCapabilities
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedListCapabilities</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedListCapabilities} obj Optional instance to populate.
   * @return {module:model/PaginatedListCapabilities} The populated <code>PaginatedListCapabilities</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [Capabilities]);
      }
  ...
  /**
   * List of items
   * @member {Array.<module:model/Capabilities>} items
   */
