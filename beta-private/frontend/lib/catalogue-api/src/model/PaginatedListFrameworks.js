...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Frameworks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Frameworks'));
  } else {
    // Browser globals (root is window)
    if (!root.CatalogueApi) {
      root.CatalogueApi = {};
    }
    root.CatalogueApi.PaginatedListFrameworks = factory(root.CatalogueApi.ApiClient, root.CatalogueApi.Frameworks);
  }
}(this, function(ApiClient, Frameworks) {
  'use strict';
  ...
  /**
   * The PaginatedListFrameworks model module.
   * @module model/PaginatedListFrameworks
   * @version 1.0.0-private-beta
   */

  /**
   * Constructs a new <code>PaginatedListFrameworks</code>.
   * A paged list of objects
   * @alias module:model/PaginatedListFrameworks
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedListFrameworks</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedListFrameworks} obj Optional instance to populate.
   * @return {module:model/PaginatedListFrameworks} The populated <code>PaginatedListFrameworks</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [Frameworks]);
      }
  ...
  /**
   * List of items
   * @member {Array.<module:model/Frameworks>} items
   */
