...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CatalogueApi.PaginatedListBlobInfo = factory(root.CatalogueApi.ApiClient, root.CatalogueApi.BlobInfo);
  }
  ...
  /**
   * The PaginatedListBlobInfo model module.
   * @module model/PaginatedListBlobInfo
   * @version 1.0.0-private-beta
   */

  /**
   * Constructs a new <code>PaginatedListBlobInfo</code>.
   * A paged list of objects
   * @alias module:model/PaginatedListBlobInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedListBlobInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedListBlobInfo} obj Optional instance to populate.
   * @return {module:model/PaginatedListBlobInfo} The populated <code>PaginatedListBlobInfo</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [BlobInfo]);
      }
  ...
  /**
   * List of items
   * @member {Array.<module:model/BlobInfo>} items
   */
