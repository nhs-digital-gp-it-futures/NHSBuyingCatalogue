...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.CapabilitiesImplementedEvidenceBlobStoreApi();
  });
  ...
  describe('CapabilitiesImplementedEvidenceBlobStoreApi', function() {
    describe('apiCapabilitiesImplementedEvidenceBlobStoreAddEvidenceForClaimPost', function() {
      it('should call apiCapabilitiesImplementedEvidenceBlobStoreAddEvidenceForClaimPost successfully', function(done) {
        //uncomment below and update the code to test apiCapabilitiesImplementedEvidenceBlobStoreAddEvidenceForClaimPost
        //instance.apiCapabilitiesImplementedEvidenceBlobStoreAddEvidenceForClaimPost(function(error) {
    ...
    describe('apiCapabilitiesImplementedEvidenceBlobStoreEnumerateFolderByClaimIdGet', function() {
      it('should call apiCapabilitiesImplementedEvidenceBlobStoreEnumerateFolderByClaimIdGet successfully', function(done) {
        ...
        //instance.apiCapabilitiesImplementedEvidenceBlobStoreEnumerateFolderByClaimIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
