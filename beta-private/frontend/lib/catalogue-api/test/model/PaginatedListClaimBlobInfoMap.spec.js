...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListClaimBlobInfoMap();
  });
  ...
  describe('PaginatedListClaimBlobInfoMap', function() {
    it('should create an instance of PaginatedListClaimBlobInfoMap', function() {
      // uncomment below and update the code to test PaginatedListClaimBlobInfoMap
      //var instance = new CatalogueApi.PaginatedListClaimBlobInfoMap();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListClaimBlobInfoMap);
    });
