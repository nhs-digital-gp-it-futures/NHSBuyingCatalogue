...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListIEnumerableStandardsApplicableEvidence();
  });
  ...
  describe('PaginatedListIEnumerableStandardsApplicableEvidence', function() {
    it('should create an instance of PaginatedListIEnumerableStandardsApplicableEvidence', function() {
      // uncomment below and update the code to test PaginatedListIEnumerableStandardsApplicableEvidence
      //var instance = new CatalogueApi.PaginatedListIEnumerableStandardsApplicableEvidence();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListIEnumerableStandardsApplicableEvidence);
    });
