...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListTechnicalContacts();
  });
  ...
  describe('PaginatedListTechnicalContacts', function() {
    it('should create an instance of PaginatedListTechnicalContacts', function() {
      // uncomment below and update the code to test PaginatedListTechnicalContacts
      //var instance = new CatalogueApi.PaginatedListTechnicalContacts();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListTechnicalContacts);
    });
