...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.StandardsApplicable();
  });
  ...
  describe('StandardsApplicable', function() {
    it('should create an instance of StandardsApplicable', function() {
      // uncomment below and update the code to test StandardsApplicable
      //var instance = new CatalogueApi.StandardsApplicable();
      //expect(instance).to.be.a(CatalogueApi.StandardsApplicable);
    });
