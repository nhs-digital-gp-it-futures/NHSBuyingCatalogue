...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.CapabilitiesImplementedEvidence();
  });
  ...
  describe('CapabilitiesImplementedEvidence', function() {
    it('should create an instance of CapabilitiesImplementedEvidence', function() {
      // uncomment below and update the code to test CapabilitiesImplementedEvidence
      //var instance = new CatalogueApi.CapabilitiesImplementedEvidence();
      //expect(instance).to.be.a(CatalogueApi.CapabilitiesImplementedEvidence);
    });
