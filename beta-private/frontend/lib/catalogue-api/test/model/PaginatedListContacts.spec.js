...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListContacts();
  });
  ...
  describe('PaginatedListContacts', function() {
    it('should create an instance of PaginatedListContacts', function() {
      // uncomment below and update the code to test PaginatedListContacts
      //var instance = new CatalogueApi.PaginatedListContacts();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListContacts);
    });
