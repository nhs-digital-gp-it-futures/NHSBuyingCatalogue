...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListBlobInfo();
  });
  ...
  describe('PaginatedListBlobInfo', function() {
    it('should create an instance of PaginatedListBlobInfo', function() {
      // uncomment below and update the code to test PaginatedListBlobInfo
      //var instance = new CatalogueApi.PaginatedListBlobInfo();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListBlobInfo);
    });
