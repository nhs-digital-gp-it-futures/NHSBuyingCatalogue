...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListCapabilities();
  });
  ...
  describe('PaginatedListCapabilities', function() {
    it('should create an instance of PaginatedListCapabilities', function() {
      // uncomment below and update the code to test PaginatedListCapabilities
      //var instance = new CatalogueApi.PaginatedListCapabilities();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListCapabilities);
    });
