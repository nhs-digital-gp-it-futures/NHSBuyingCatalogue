...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListSolutions();
  });
  ...
  describe('PaginatedListSolutions', function() {
    it('should create an instance of PaginatedListSolutions', function() {
      // uncomment below and update the code to test PaginatedListSolutions
      //var instance = new CatalogueApi.PaginatedListSolutions();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListSolutions);
    });
