...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListKeywordCount();
  });
  ...
  describe('PaginatedListKeywordCount', function() {
    it('should create an instance of PaginatedListKeywordCount', function() {
      // uncomment below and update the code to test PaginatedListKeywordCount
      //var instance = new CatalogueApi.PaginatedListKeywordCount();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListKeywordCount);
    });
