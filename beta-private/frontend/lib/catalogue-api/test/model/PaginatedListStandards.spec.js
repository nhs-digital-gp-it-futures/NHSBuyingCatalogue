...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListStandards();
  });
  ...
  describe('PaginatedListStandards', function() {
    it('should create an instance of PaginatedListStandards', function() {
      // uncomment below and update the code to test PaginatedListStandards
      //var instance = new CatalogueApi.PaginatedListStandards();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListStandards);
    });
