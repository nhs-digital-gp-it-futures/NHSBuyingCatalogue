...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListIEnumerableStandardsApplicableReviews();
  });
  ...
  describe('PaginatedListIEnumerableStandardsApplicableReviews', function() {
    it('should create an instance of PaginatedListIEnumerableStandardsApplicableReviews', function() {
      // uncomment below and update the code to test PaginatedListIEnumerableStandardsApplicableReviews
      //var instance = new CatalogueApi.PaginatedListIEnumerableStandardsApplicableReviews();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListIEnumerableStandardsApplicableReviews);
    });
