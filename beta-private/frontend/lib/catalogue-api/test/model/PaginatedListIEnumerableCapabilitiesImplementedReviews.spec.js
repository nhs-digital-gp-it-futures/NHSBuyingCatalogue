...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListIEnumerableCapabilitiesImplementedReviews();
  });
  ...
  describe('PaginatedListIEnumerableCapabilitiesImplementedReviews', function() {
    it('should create an instance of PaginatedListIEnumerableCapabilitiesImplementedReviews', function() {
      // uncomment below and update the code to test PaginatedListIEnumerableCapabilitiesImplementedReviews
      //var instance = new CatalogueApi.PaginatedListIEnumerableCapabilitiesImplementedReviews();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListIEnumerableCapabilitiesImplementedReviews);
    });
