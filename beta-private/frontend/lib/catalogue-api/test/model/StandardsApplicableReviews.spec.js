...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.StandardsApplicableReviews();
  });
  ...
  describe('StandardsApplicableReviews', function() {
    it('should create an instance of StandardsApplicableReviews', function() {
      // uncomment below and update the code to test StandardsApplicableReviews
      //var instance = new CatalogueApi.StandardsApplicableReviews();
      //expect(instance).to.be.a(CatalogueApi.StandardsApplicableReviews);
    });
