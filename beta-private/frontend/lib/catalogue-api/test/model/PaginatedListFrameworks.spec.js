...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListFrameworks();
  });
  ...
  describe('PaginatedListFrameworks', function() {
    it('should create an instance of PaginatedListFrameworks', function() {
      // uncomment below and update the code to test PaginatedListFrameworks
      //var instance = new CatalogueApi.PaginatedListFrameworks();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListFrameworks);
    });
