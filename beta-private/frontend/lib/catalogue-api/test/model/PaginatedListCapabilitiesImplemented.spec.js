...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CatalogueApi.PaginatedListCapabilitiesImplemented();
  });
  ...
  describe('PaginatedListCapabilitiesImplemented', function() {
    it('should create an instance of PaginatedListCapabilitiesImplemented', function() {
      // uncomment below and update the code to test PaginatedListCapabilitiesImplemented
      //var instance = new CatalogueApi.PaginatedListCapabilitiesImplemented();
      //expect(instance).to.be.a(CatalogueApi.PaginatedListCapabilitiesImplemented);
    });
