...
namespace NHSD.GPITF.BuyingCatalog.Datastore.CRM.SystemTests
{
  ...
  public sealed class CapabilitiesDatastore_Tests : DatastoreBase_Tests<CapabilitiesDatastore>
  {
    ...
    {
      Assert.DoesNotThrow(() => new CapabilitiesDatastore(DatastoreBaseSetup.CrmConnectionFactory, _logger, _policy, _config));
    }

    [Test]
    public void GetAll_ReturnsData()
    {
      var datastore = new CapabilitiesDatastore(DatastoreBaseSetup.CrmConnectionFactory, _logger, _policy, _config);
