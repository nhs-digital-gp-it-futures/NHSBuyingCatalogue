...
namespace NHSD.GPITF.BuyingCatalog.Datastore.CRM.SystemTests
{
  ...
  public sealed class ContactsDatastore_Tests : DatastoreBase_Tests<ContactsDatastore>
  {
    ...
    {
      Assert.DoesNotThrow(() => new ContactsDatastore(DatastoreBaseSetup.ContactsDatastore, _logger, _policy, _config, new Mock<IDatastoreCache>().Object));
    }
    ...
    public void ByEmail_ReturnsData()
    {
      ...
      var datastore = new ContactsDatastore(DatastoreBaseSetup.ContactsDatastore, _logger, _policy, _config, new Mock<IDatastoreCache>().Object);
