...
namespace NHSD.GPITF.BuyingCatalog.Datastore.CRM.SystemTests
{
  ...
  public sealed class FrameworksDatastore_Tests : DatastoreBase_Tests<FrameworksDatastore>
  {
    ...
    {
      Assert.DoesNotThrow(() => new FrameworksDatastore(DatastoreBaseSetup.FrameworksDatastore, _logger, _policy));
    }

    [Test]
    public void GetAll_ReturnsData()
    {
      var datastore = new FrameworksDatastore(DatastoreBaseSetup.FrameworksDatastore, _logger, _policy);
