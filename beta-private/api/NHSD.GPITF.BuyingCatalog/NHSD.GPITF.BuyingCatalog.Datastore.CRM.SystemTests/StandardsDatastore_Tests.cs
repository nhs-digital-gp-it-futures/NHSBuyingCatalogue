...
namespace NHSD.GPITF.BuyingCatalog.Datastore.CRM.SystemTests
{
  ...
  public sealed class StandardsDatastore_Tests : DatastoreBase_Tests<StandardsDatastore>
  {
    ...
    {
      Assert.DoesNotThrow(() => new StandardsDatastore(DatastoreBaseSetup.StandardsDatastore, _logger, _policy, _config, _cache));
    }

    [Test]
    public void GetAll_ReturnsData()
    {
      var datastore = new StandardsDatastore(DatastoreBaseSetup.StandardsDatastore, _logger, _policy, _config, _cache);
    ...
    {
      var capsDatastore = new CapabilitiesDatastore(DatastoreBaseSetup.CapabilitiesDatastore, new Mock<ILogger<CapabilitiesDatastore>>().Object, _policy, _config, _cache);
