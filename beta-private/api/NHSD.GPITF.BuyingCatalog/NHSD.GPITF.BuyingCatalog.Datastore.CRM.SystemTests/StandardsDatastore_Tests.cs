...
namespace NHSD.GPITF.BuyingCatalog.Datastore.CRM.SystemTests
{
  ...
  public sealed class StandardsDatastore_Tests : DatastoreBase_Tests<StandardsDatastore>
  {
    ...
    {
      Assert.DoesNotThrow(() => new StandardsDatastore(DatastoreBaseSetup.CrmConnectionFactory, _logger, _policy, _config));
    }

    [Test]
    public void GetAll_ReturnsData()
    {
      var datastore = new StandardsDatastore(DatastoreBaseSetup.CrmConnectionFactory, _logger, _policy, _config);
