...
namespace NHSD.GPITF.BuyingCatalog.Datastore.CRM.Tests
{
  ...
  public sealed class ReviewsDatastoreBase_Tests
  {
    ...
    {
      Assert.DoesNotThrow(() => new DummyReviewsDatastoreBase(_crmConnectionFactory.Object, _logger.Object, _policy.Object));
    }

    [Test]
    public void Class_Implements_Interface()
    {
      var obj = new DummyReviewsDatastoreBase(_crmConnectionFactory.Object, _logger.Object, _policy.Object);
