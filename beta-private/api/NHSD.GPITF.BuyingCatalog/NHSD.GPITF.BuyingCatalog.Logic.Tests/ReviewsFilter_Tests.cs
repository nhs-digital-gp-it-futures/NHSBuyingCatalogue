...
{
  [TestFixture]
  public sealed class ReviewsFilter_Tests
  {
    ...
    {
      Assert.DoesNotThrow(() => new ReviewsFilter(_context.Object, _solutionDatastore.Object));
    }
    ...
    public void Filter_Admin_ReturnsAll()
    {
      ...
      var filter = new ReviewsFilter(_context.Object, _solutionDatastore.Object);
      var assMesses = new[]
      {
