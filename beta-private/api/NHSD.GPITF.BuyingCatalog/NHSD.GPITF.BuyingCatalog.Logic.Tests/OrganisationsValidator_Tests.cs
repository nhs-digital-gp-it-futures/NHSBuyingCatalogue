...
{
  [TestFixture]
  public sealed class OrganisationsValidator_Tests
  {
    ...
    {
      Assert.DoesNotThrow(() => new OrganisationsValidator(_context.Object));
    }
    ...
    public void Validate_NonAdmin_Create_Returns_Error(string role)
    {
      ...
      var validator = new OrganisationsValidator(_context.Object);

      var valres = validator.Validate(new Organisations(), ruleSet: nameof(IOrganisationsLogic.Create));
    ...
    public void Validate_NonAdmin_Update_Returns_Error(string role)
    {
      ...
      var valres = validator.Validate(new Organisations(), ruleSet: nameof(IOrganisationsLogic.Update));
    ...
    public void Validate_NonAdmin_Delete_Returns_Error(string role)
    {
      ...
      var valres = validator.Validate(new Organisations(), ruleSet: nameof(IOrganisationsLogic.Delete));
