...
{
  [TestFixture]
  public sealed class FrameworksValidator_Tests
  {
    ...
    {
      Assert.DoesNotThrow(() => new FrameworksValidator(_context.Object));
    }
    ...
    public void Validate_Admin_Create_Returns_NoError()
    {
      ...
      var validator = new FrameworksValidator(_context.Object);

      var valres = validator.Validate(new Frameworks(), ruleSet: nameof(IFrameworksLogic.Create));
    ...
    public void Validate_Admin_Update_Returns_NoError()
    {
      ...
      var valres = validator.Validate(new Frameworks(), ruleSet: nameof(IFrameworksLogic.Update));
