...
{
  [TestFixture]
  public sealed class CapabilitiesValidator_Tests
  {
    ...
    {
      Assert.DoesNotThrow(() => new CapabilitiesValidator(_context.Object));
    }
    ...
    public void Validate_Admin_Create_Returns_NoError()
    {
      ...
      var validator = new CapabilitiesValidator(_context.Object);

      var valres = validator.Validate(new Capabilities(), ruleSet: nameof(ICapabilitiesLogic.Create));
    ...
    public void Validate_Admin_Update_Returns_NoError()
    {
      ...
      var valres = validator.Validate(new Capabilities(), ruleSet: nameof(ICapabilitiesLogic.Update));
