...
namespace NHSD.GPITF.BuyingCatalog.EvidenceBlobStore.SharePoint.App
{
  public static class Settings
  {
    ...
    public static string SHAREPOINT_FILE_DOWNLOAD_BASE_URL(IConfiguration config) => Environment.GetEnvironmentVariable("SHAREPOINT_FILE_DOWNLOAD_BASE_URL") ?? config["SharePoint:FileDownloadBaseUrl"];
  }
}