...
namespace NHSD.GPITF.BuyingCatalog.Search.Tests
{
  ...
  public sealed class SearchDatastore_Tests
  {
    ...
    public void SolutionExByKeyword_KeywordInName_ReturnsSolution(
      string solutionName,
      string keyword)
    {
    ...
    public void SolutionExByKeyword_KeywordInDescription_ReturnsSolution(
    ...
    public void SolutionExByKeyword_KeywordNotInName_ReturnsNone(
      string solutionName,
      string keyword)
    {
      var framework = Creator.GetFramework();
      ...
      var soln = Creator.GetSolution(description: solutionName);
      _solutionDatastore.Setup(x => x.ByFramework(framework.Id)).Returns(new[] { soln });
    ...
    public void SolutionExByKeyword_KeywordNotInDescription_ReturnsNone(
      string solutionDescription,
      string keyword)
    {
      var framework = Creator.GetFramework();
      ...
      var soln = Creator.GetSolution(name: solutionDescription);
      _solutionDatastore.Setup(x => x.ByFramework(framework.Id)).Returns(new[] { soln });
