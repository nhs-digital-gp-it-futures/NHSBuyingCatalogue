...
namespace NHSD.GPITF.BuyingCatalog.Controllers
{
  ...
  public sealed class CapabilitiesImplementedEvidenceController : Controller
  {
    ...
    {
      var capEvidenc = _logic.ByCapabilitiesImplemented(capabilitiesImplementedId);
      var retval = PaginatedList<CapabilitiesImplementedEvidence>.Create(capEvidenc, pageIndex, pageSize);
