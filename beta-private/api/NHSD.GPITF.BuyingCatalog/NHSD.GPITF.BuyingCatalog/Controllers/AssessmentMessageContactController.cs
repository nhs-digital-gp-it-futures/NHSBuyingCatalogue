...
namespace NHSD.GPITF.BuyingCatalog.Controllers
{
  ...
  public sealed class AssessmentMessageContactController : Controller
  {
    private readonly IAssessmentMessageContactLogic _logic;

    /// <summary>
    /// constructor
    /// </summary>
    /// <param name="logic">business logic</param>
    public AssessmentMessageContactController(IAssessmentMessageContactLogic logic)
    {
      _logic = logic;
    }
    ...
    [ValidateModelState]
    [SwaggerResponse(statusCode: (int)HttpStatusCode.OK, type: typeof(PaginatedList<AssessmentMessageContact>), description: "Success")]
    ...
    public IActionResult ByAssessmentMessage([FromRoute][Required]string assMessId, [FromQuery]int? pageIndex, [FromQuery]int? pageSize)
    {
      ...
      var retval = PaginatedList<AssessmentMessageContact>.Create(assMessConts, pageIndex, pageSize);
    ...
    [Route("Create")]
    [ValidateModelState]
    [SwaggerResponse(statusCode: (int)HttpStatusCode.OK, type: typeof(AssessmentMessageContact), description: "Success")]
    [SwaggerResponse(statusCode: (int)HttpStatusCode.NotFound, description: "AssessmentMessage or Contact not found in CRM")]
    [SwaggerRequestExample(typeof(AssessmentMessageContact), typeof(AssessmentMessageContactExample), jsonConverter: typeof(StringEnumConverter))]
    ...
    [SwaggerResponse(statusCode: (int)HttpStatusCode.NotFound, description: "AssessmentMessageContact not found in CRM")]
    [SwaggerRequestExample(typeof(AssessmentMessageContact), typeof(AssessmentMessageContactExample), jsonConverter: typeof(StringEnumConverter))]
    public IActionResult Delete([FromBody]AssessmentMessageContact assMessCont)
    {
      try
      {
