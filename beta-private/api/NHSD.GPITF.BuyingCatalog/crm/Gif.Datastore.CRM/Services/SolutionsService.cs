...
{
  public class SolutionsService : ServiceBase, ISolutionsDatastore
  {
    ...
    public Solution ById(string id)
    {
      ...
      var appJson = Repository.RetrieveMultiple(new Solution().GetQueryString(null, filterAttributes));
